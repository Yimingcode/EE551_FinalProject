...
class App:
    def __init__(self, parent):
        ...
        self.main_canvas = Canvas(self.root, width=WIDTH, height=WIDTH, bg="lightgrey")
    ...
    def _sframesetup(self):
        ...
        Label(pointframe, text="Score:").pack(side=LEFT)
    ...
    def _spawnnew(self):
        ...
        while True:
            ...
            self.table[pos] = cell.Cell(self.main_canvas, self.root, posconv, WIDTH / 4, n=2 ** ri(1, 2))
            break
