...
Speed = 1  # ms between frames

COLOR = defaultdict(lambda: "#ffffff",
...
class Cell:
    ...
    def double(self):
        ...
        self.canvas.itemconfig(self.id + "cell", fill=COLOR[str(self.n)])
    ...
    def _draw(self):
        ...
        self.canvas.create_rectangle(x * self.l, y * self.l, (x + 1) * self.l, (y + 1) * self.l, fill=COLOR[str(self.n)],
    ...
    def _moveloop(self, tomovex, tomovey):
        ...
        self.root.after(Speed, lambda: self._moveloop(newx, newy))
